...
const PlusJakartaSansFont: AppFont = {
...
const EnglishFont = {
    SoraFont: SoraFont,
    PlusJakartaSansFont: PlusJakartaSansFont,
};

const CUSTOM_FONT = {
    en: {
        DEFAULT: EnglishFont.PlusJakartaSansFont,
        SORA_FONT: EnglishFont.SoraFont,
        PLUS_JAKARTA_SANS_FONT: EnglishFont.PlusJakartaSansFont,
    },
};
