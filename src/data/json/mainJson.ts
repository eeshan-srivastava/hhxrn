import { CompetitionItemBean } from '../../app/presentation/bean/CompetitionItemBean';
import { AppLinkType } from '../../app/utils/AppLinkUtils';
...
const checkboxBean = {
    text: 'By signing up, I agree to the following    ',
    items: [
        {
            text: 'Terms and Condidtions',
            appLink: { type: AppLinkType.webLink, url: 'https://www.youtube.com/' },
        },
        {
            text: 'Privacy Policy',
            appLink: { type: AppLinkType.webLink, url: 'https://ggogle.com/' },
        },
    ],
};

const competitions: Array<CompetitionItemBean> = [
    {
        id: '1',
